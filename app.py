...
with col1:
    ...
    if esports_option == "Counter-Strike":
        ...
        cs_option = st.selectbox(
            ...
            ["Select Type", "Teams Metrics", "Teams Win Rate", "Rounds Per Stage","Round Efficiency", 
...
with col3:
    ...
    if esports_option == "Counter-Strike":
        ...
        st.logo(r"D:\DESKTOP\pfaiproj\bin\img\Counter-Strike.png")
        ...
        if cs_option == "Teams Metrics":
            ...
            top_5_teams = Winners_of_each_stage(df)
            st.write(top_5_teams)
